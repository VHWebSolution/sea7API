package com.cadastroproduto.cadastro.infra;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/barcos/salvar").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/barcos/atualizar/{id}").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/barcos/deletar/{id}").hasRole("ADMIN")
